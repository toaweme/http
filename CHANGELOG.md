...
- Add CORS middleware to server by [@iberflow](https://github.com/iberflow) in [#6](https://github.com/toaweme/http/pull/6).

### Documentation

- Link to docs site from README by [@iberflow](https://github.com/iberflow) in [b4a8292](https://github.com/toaweme/http/commit/b4a8292ad508a9483bc6efe632c5acc60fe731cd).
